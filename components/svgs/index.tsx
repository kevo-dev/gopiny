...
export const Blob1 = ({ size }: Props) => (
<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  <path fill="#0F62FE" d="M36.9,-56C51.3,-48.2,68.9,-43.8,71.4,-33.9C73.9,-24,61.4,-8.5,53,3.3C44.6,15.1,40.4,23.2,36.2,35.6C32,47.9,27.9,64.6,18.8,70.2C9.6,75.7,-4.6,70.1,-16.2,63.1C-27.8,56.1,-36.6,47.8,-48.5,39.2C-60.3,30.6,-75,21.7,-75.7,11.4C-76.5,1,-63.2,-10.9,-56.8,-26.4C-50.4,-41.9,-51,-61,-42.7,-71.7C-34.3,-82.3,-17.2,-84.5,-3,-79.9C11.3,-75.3,22.5,-63.9,36.9,-56Z" transform="translate(100 100)" />
</svg>
);

export const Blob2 = ({ size }: Props) => (
  <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  <path fill="#0F62FE" d="M38.5,-69.4C46,-62.3,45.6,-44.2,51.3,-30.8C57,-17.4,68.8,-8.7,72.2,1.9C75.5,12.6,70.5,25.2,64.8,38.7C59.2,52.2,53,66.6,42.1,74C31.2,81.5,15.6,82,1.4,79.6C-12.8,77.2,-25.7,72,-38.4,65.6C-51,59.1,-63.5,51.5,-72.3,40.4C-81,29.3,-86,14.6,-81.9,2.3C-77.8,-9.9,-64.7,-19.9,-54.6,-28.5C-44.4,-37.2,-37.2,-44.6,-28.6,-51.2C-20,-57.7,-10,-63.4,2.7,-68.2C15.5,-72.9,30.9,-76.6,38.5,-69.4Z" transform="translate(100 100)" />
</svg>
  );

  
export const Blob3 = ({ size }: Props) => (
  <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  <path fill="#0F62FE" d="M17.6,-31.6C22.7,-20.6,26.5,-15.2,38.4,-6C50.2,3.2,70.1,16.2,66.4,19.8C62.8,23.3,35.6,17.4,20.6,25C5.6,32.7,2.8,53.9,-6.3,62.5C-15.3,71.1,-30.6,67.1,-42.1,58.4C-53.7,49.6,-61.4,36.1,-65.2,21.8C-68.9,7.6,-68.6,-7.3,-59.3,-14.1C-50,-20.9,-31.6,-19.6,-20.3,-28.5C-8.9,-37.4,-4.4,-56.6,0.9,-57.8C6.3,-59.1,12.6,-42.5,17.6,-31.6Z" transform="translate(100 100)" />
</svg>
  );
