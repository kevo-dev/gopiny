...
export const SITE_NAME = "Gopiny Lake Tours";
export const SITE_TITLE =
  "Gopiny Lake Tours - Your Ultimate Guide to Kisumu";
export const SITE_DESCRIPTION =
  "Experience the beauty of Kisumu with Gopiny Lake Tours Agency. Our expert guides will show you the best sights and sounds of Kisumu. Book now!";
export const SITE_IMAGE_URL = process.env.SITE_IMAGE_URL;
// TODO: modify the site ID for twitter
const TWITTER_CREATOR = "@cave-o";
